...
import { CONTEXT_WINDOW_EXCEEDED_CODE, EMPTY_RESPONSE_CODE, LlmAdapter, LlmError, ProviderRequestId, QUOTA_EXCEEDED_CODE, ReasoningEffortId, RetryPolicySchema, ToolCallId, contentHasImage, isContextWindowExceededError, isQuotaExceededError, resolveRetryPolicy, userAgent } from "@deepseek-ai/dsh-llm";
...
function foldTurns(messages, images) {
	...
	for (const message of messages) {
		...
		const messageText = message.role === "tool" ? "" : text$3;
